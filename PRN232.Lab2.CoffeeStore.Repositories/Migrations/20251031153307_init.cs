    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoffeeAddons", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrewMethod = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoffeeVariants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoffeeVariants_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoffeePriceSchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoffeePriceSchedules_CoffeeVariants_VariantId",
                        column: x => x.VariantId,
                        principalTable: "CoffeeVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_CoffeeVariants_VariantId",
                        column: x => x.VariantId,
                        principalTable: "CoffeeVariants",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItemAddons_CoffeeAddons_AddonId",
                        column: x => x.AddonId,
                        principalTable: "CoffeeAddons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItemAddons_OrderDetails_OrderDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoffeePriceSchedules_VariantId",
                table: "CoffeePriceSchedules",
                column: "VariantId");

            migrationBuilder.CreateIndex(
                name: "IX_CoffeeVariants_ProductId",
                table: "CoffeeVariants",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemAddons_OrderDetailId",
                table: "OrderItemAddons",
