...
namespace PRN232.Lab2.CoffeeStore.Repositories.Migrations
{
    ...
    [Migration("20251103074912_Add-chat-db")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRN232.Lab2.CoffeeStore.Repositories.Entities.Conversation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PRN232.Lab2.CoffeeStore.Repositories.Entities.Message", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PRN232.Lab2.CoffeeStore.Repositories.Entities.Participant", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PRN232.Lab2.CoffeeStore.Repositories.Entities.Message", b =>
                {
                    b.HasOne("PRN232.Lab2.CoffeeStore.Repositories.Entities.Conversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PRN232.Lab2.CoffeeStore.Repositories.Entities.User", "Sender")
